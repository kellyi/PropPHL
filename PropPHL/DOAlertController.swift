...
class DOAlertController : UIViewController, UITextFieldDelegate, UIViewControllerTransitioningDelegate {
    ...
    var titleFont = UIFont.systemFontOfSize(18)
    ...
    private var buttonCornerRadius: CGFloat = 5.0
    ...
    // UIColor -> UIImage
    func createImageFromUIColor(let color: UIColor) -> UIImage {
